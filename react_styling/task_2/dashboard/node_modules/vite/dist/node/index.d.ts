...
export { ConnectedPayload, CustomPayload, ErrorPayload, FullReloadPayload, HMRPayload, HotPayload, PrunePayload, Update, UpdatePayload } from 'vvite/types/hmrPayload.js
import { InferCustomEventPayload } from 'vivite/types/customEvent.jsexport { CustomEventMap, InferCustomEventPayload, InvalidatePayload } from 'vitvite/types/customEvent.jsmport { SecureContextOptions } from 'node:tls';
import { ZlibOptions } from 'node:zlib';
import * as PostCSS from 'postcss';
import { LightningCSSOptions } from 'vitevite/types/internal/lightningcssOptions.jsport { LightningCSSOptions } from 'vite/vite/types/internal/lightningcssOptions.jsort { SassLegacyPreprocessBaseOptions, SassModernPreprocessBaseOptions, LessPreprocessorBaseOptions, StylusPreprocessorBaseOptions } from 'vite/tvite/types/internal/cssPreprocessorOptions.jsrt { M as ModuleRunnerTransport } from './moduleRunnerTransport.d-DJ_mE5sf.js';
export { GeneralImportGlobOptions, ImportGlobFunction, ImportGlobOptions, KnownAsTypeMap } from 'vite/tyvite/types/importGlob.jst { ChunkMetadata, CustomPluginOptionsVite } from 'vite/typvite/types/metadata.jsface Alias {
  find: string | RegExp
  replacement: string
  /**
