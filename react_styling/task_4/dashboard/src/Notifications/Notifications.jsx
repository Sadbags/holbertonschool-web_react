...
class Notifications extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={`notifications-root fixed sm:static right-0 top-0 sm:right-auto sm:top-auto sm:w-auto sm:h-auto
        ${displayDrawer ? "block" : "hidden"}
      ...
      >
        <div className="notification-title text-right font-semibold text-lg mb-2">
          Your notifications
        </div>
